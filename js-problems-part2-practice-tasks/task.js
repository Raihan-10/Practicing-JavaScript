...
function totalBudget(laptopQuantity,tabletQuantity, mobileQuantity){
    ...
    tablet = 15000,
    mobile = 20000;
    const moneyNeededForLaptop = laptop*laptopQuantity;
    const moneyNeededForTablet = tablet*tabletQuantity;
    const moneyNeededForMobile = mobile*mobileQuantity;
    let sum = moneyNeededForLaptop+moneyNeededForTablet+moneyNeededForMobile;
    return sum;
